...
def upgrade() -> None:
    ...
    sa.Column('state', sa.Enum('UNKNOWN', 'START', 'ABOUT_BOT', 'ERROR_REPORT', 'CHOICE_UNIVERSITY', 'CHOICE_INSTITUTE', 'CHOICE_COURSE', 'CHOICE_GROUP', 'DISPLAY_SCHEDULE', name='user_state'), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('is_numerator', 'day', 'start_time', 'end_time', 'valid_from', 'valid_to', 'group_id', name='unique_lesson_for_group')
    )
